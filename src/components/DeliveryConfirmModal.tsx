          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                মেমো: <span className="font-mono text-amber-300 font-semibold">{order.memoNo}</span>
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4 overflow-y-auto">
          ...
          <div className="bg-slate-950/70 border border-slate-800 p-3.5 rounded-xl space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2 pt-2 border-t border-slate-800/80 text-center">
              ...
              <div className="p-2 bg-slate-900/90 rounded-lg">
                <span className="text-[10px] text-slate-400 block">পূর্বে বুকিংয়ে জমা</span>
                <span className="text-xs sm:text-sm font-bold text-emerald-400">
                  {formatTaka(previousPaid)}
                </span>
              </div>
              <div className="p-2 bg-slate-900/90 rounded-lg">
                <span className="text-[10px] text-slate-400 block">বকেয়া বিল</span>
            ...
            <div className="text-[11px] text-slate-400 flex items-center justify-between pt-1">
              ...
              <span>
                মোট জোড়া: <strong className="text-slate-200">{toBnDigit(order.totalPairs)} জোড়া</strong> ({pairsToCartonText(order.totalPairs, 12)})
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2 text-sm text-slate-200 focus:outline-none focus:border-amber-400"
              required
            />
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0"
                className="w-full bg-slate-950 border border-slate-800 rounded-xl pl-8 pr-3.5 py-2.5 text-base font-bold text-emerald-400 focus:outline-none focus:border-emerald-500"
              />
            </div>
            ...
            <div className="flex items-center gap-1.5 mt-2 overflow-x-auto pb-1">
              <button
                ...
                className="px-2.5 py-1 bg-emerald-500/15 hover:bg-emerald-500/25 text-emerald-300 rounded-lg text-xs font-semibold whitespace-nowrap transition cursor-pointer"
              >
              ...
              {initialRemaining > 1000 && (
                <button
                  ...
                  className="px-2.5 py-1 bg-slate-800 hover:bg-slate-750 text-slate-300 rounded-lg text-xs font-semibold whitespace-nowrap transition cursor-pointer"
                >
              ...
              <button
                ...
                className="px-2.5 py-1 bg-rose-500/15 hover:bg-rose-500/25 text-rose-300 rounded-lg text-xs font-semibold whitespace-nowrap transition cursor-pointer"
              >
                কোনো জমা নেই (৳০)
              </button>
            </div>
          ...
          <div className="bg-gradient-to-br from-slate-950 to-slate-900 border border-amber-500/30 p-3.5 rounded-xl space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2 text-center pt-1 text-xs">
              <div className="bg-slate-900/90 p-2 rounded-lg border border-slate-800">
                ...
                <strong className="text-amber-400 font-bold">+{formatTaka(order.grandTotal)}</strong>
              </div>
              <div className="bg-slate-900/90 p-2 rounded-lg border border-slate-800">
                <span className="text-[10px] text-slate-400 block">আজকের জমা</span>
                <strong className="text-emerald-400 font-bold">+{formatTaka(collectedCash)}</strong>
              </div>
              <div className="bg-slate-900/90 p-2 rounded-lg border border-slate-800">
                <span className="text-[10px] text-slate-400 block">নতুন বাকী</span>
                <strong className="text-rose-400 font-bold">+{formatTaka(newDueAmount)}</strong>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-slate-800">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="px-5 py-2.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 rounded-xl text-xs font-black flex items-center gap-2 shadow-lg shadow-emerald-500/20 transition cursor-pointer"
            >
