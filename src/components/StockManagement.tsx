...
export const StockManagement: React.FC<StockManagementProps> = ({
  ...
  return (
    <div className="space-y-6" onClick={() => { setActiveMenuProductId(null); setIsCategoryDropdownOpen(false); }}>
      ...
      {/* Clean Unified Stock & Valuation Card */}
      <div className="bg-white dark:bg-slate-900/80 border border-slate-200/90 dark:border-slate-800 p-4 sm:p-5 rounded-2xl shadow-xs">
        ...
        <div className="flex items-center justify-between gap-2 pb-3 border-b border-slate-100 dark:border-slate-800/70">
          <div className="flex items-center gap-2 min-w-0">
            <h3 className="text-sm sm:text-base font-bold text-slate-900 dark:text-white shrink-0">মোট মজুদ ওভারভিউ</h3>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-4 mt-3.5">
          {/* 1. মোট মজুদ */}
          <div className="bg-slate-50/70 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/80 rounded-xl p-2.5 sm:p-3 flex flex-col justify-between shadow-xs">
            <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-slate-400">মোট মজুদ</span>
            <div className="text-sm sm:text-base font-black text-amber-700 dark:text-amber-300 font-mono mt-1 truncate">
          ...
          <div className="bg-slate-50/70 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/80 rounded-xl p-2.5 sm:p-3 flex flex-col justify-between shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-[11px] sm:text-xs font-semibold text-slate-500 dark:text-slate-400">মোট ক্রয়মূল্য</span>
              <button
                type="button"
                onClick={() => setShowBuyPrice(!showBuyPrice)}
            ...
            <div className="text-sm sm:text-base font-black text-rose-600 dark:text-rose-400 font-mono mt-1 truncate">
          ...
          {/* 3. ফ্রি ও বুকড স্টক */}
          <div className="col-span-2 sm:col-span-1 bg-slate-50/70 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/80 rounded-xl p-2.5 sm:p-3 flex flex-col justify-between shadow-xs">
            <div className="flex items-center justify-between">
            ...
            <div className="text-sm sm:text-base font-black text-emerald-700 dark:text-emerald-300 font-mono mt-1 truncate">
